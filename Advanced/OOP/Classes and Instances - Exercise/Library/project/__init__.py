...
class TestsUser(unittest.TestCase):
    ...
    def test_get_book_method_with_book_available_in_the_library_should_add_it_in_the_books_list(self):
        ...
        result = self.user.get_book(
            'J.K.Rowling', 'Harry Potter and the Deathly Hallows', 17, self.library)
        self.assertEqual(
            result, 'Harry Potter and the Deathly Hallows successfully rented for the next 17 days!')
        self.assertEqual(self.user.books, [
                         "Harry Potter and the Deathly Hallows"])
        self.assertEqual(self.library.rented_books, {'Valentina': {
    ...
    def test_return_book_method_with_rented_book_should_remove_from_user_records_and_add_it_back_to_library_records(
        ...
        self.library.books_available.update({'J.K.Rowling': ['Harry Potter and the Philosopher\'s Stone',
                                                             ...
                                                             'Harry Potter and the Order of the Phoenix']})
        self.user.get_book(
            'J.K.Rowling', 'Harry Potter and the Deathly Hallows', 3, self.library)
        self.user.get_book(
            'J.K.Rowling', 'Harry Potter and the Order of the Phoenix', 12, self.library)
        self.assertEqual(self.user.books,
                         ['Harry Potter and the Deathly Hallows', 'Harry Potter and the Order of the Phoenix'])
        self.user.return_book(
            'J.K.Rowling', 'Harry Potter and the Deathly Hallows', self.library)
        self.assertEqual(self.user.books, [
                         'Harry Potter and the Order of the Phoenix'])
        self.assertEqual(self.library.books_available, {'J.K.Rowling': ['Harry Potter and the Philosopher\'s Stone',
                                                                        'Harry Potter and the Deathly Hallows']})
    ...
    def test_return_book_method_with_book_NOT_rented_by_the_user_should_return_message(self):
        ...
        result = self.user.return_book(
            'J.K.Rowling', 'Harry Potter and the Order of the Phoenix', self.library)
        self.assertEqual(
    ...
    def test_info_method_should_return_sorted_books_list(self):
        self.library.books_available.update({'J.K.Rowling': ['Harry Potter and the Philosophers Stone',
                                                             ...
                                                             'Harry Potter and the Order of the Phoenix']})
        self.user.get_book(
            'J.K.Rowling', 'Harry Potter and the Order of the Phoenix', 3, self.library)
        self.user.get_book(
            'J.K.Rowling', 'Harry Potter and the Philosophers Stone', 3, self.library)
        self.user.get_book(
            'J.K.Rowling', 'Harry Potter and the Deathly Hallows', 3, self.library)
    ...
    def test_add_user_method_with_valid_data_should_update_records_properly(self):
        ...
        self.assertEqual(
            library.user_records[0].__str__(), '12, Valentina, []')
